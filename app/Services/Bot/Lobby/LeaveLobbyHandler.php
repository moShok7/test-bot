        ...
        if ($wasHost) {
            ...
            */
            ...
            if ($newHost) {
                ...
                |--------------------------------------------------------------------------
                |
                | Полностью удаляем лобби:
                |
                | 1. Удаляем Telegram-уведомления
                |    из личных чатов и групп.
                |
                | 2. Удаляем записи уведомлений из БД.
                |
                | 3. Удаляем игроков лобби.
                |
                | 4. Удаляем само лобби.
                |--------------------------------------------------------------------------
                */
                ...
                */
                ...
                /*
                |--------------------------------------------------------------------------
                | Удаляем оставшиеся записи игроков
                |--------------------------------------------------------------------------
                */
                ...
                /*
                |--------------------------------------------------------------------------
                | Запоминаем ID лобби для сообщения
                |--------------------------------------------------------------------------
                */

                $deletedLobbyId = $lobby->id;
                ...
                */
                ...
                $telegram->sendMessage([
                    ...
                    'text' =>
                        "🚪 Вы вышли из лобби.\n\n" .
                        "❌ Лобби #{$deletedLobbyId} удалено, " .
                        "так как игроков больше не осталось.",
